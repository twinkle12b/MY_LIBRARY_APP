...
export const ManageLibraryPage = () => {
    ...
    const [messaesClicked, setMessagesClicked] = useState(false);
    ...
    function messageClickedFunction() {
        setChangeQuantityOfBooksCLicked(false);
            ...
            <div className='mt-5'>
                ...
                <nav>
                    <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                        ...
                        <button onClick={messageClickedFunction} className='nav-link' id='nav-messages-tab' data-bs-toggle='tab'
