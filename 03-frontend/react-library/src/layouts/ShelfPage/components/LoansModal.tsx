...
export const LoansModal: React.FC<{ shelfCurrentLoan: ShelfCurrentLoans, mobile: boolean, returnBook: any, renewLoan: any }>
    = (props) => {
        return (
                            ...
                            <div className='container'>
                                <div className='mt-3'>
                                    ...
                                    <div className='list-group mt-3'>
                                        ...
                                        <button data-bs-dismiss='modal' onClick={props.shelfCurrentLoan.daysLeft < 0 ?
